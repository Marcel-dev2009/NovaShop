      ...
      <section>
        ...
        max-w-[1200px]">
          <div className="md:items-center tranform -translate-x-6 translate-y-[11rem] ">
            <h2 className=" transform -translate-y-[10rem] -translate-x-[2rem] md:-translate-y-0 md:-translate-x-0 text-[1.2rem] whitespace-nowrap md:text-3xl font-bold" id="shop">Welcome to NovaShop</h2> <br />
            <p className="text-xs transform -translate-y-[11rem] whitespace-nowrap -translate-x-[3rem] md:-translate-y-0 md:-translate-x-0 ">Discover the latest products at the best prices</p>
          ...
          <Image src={products.data[0].images[0]} alt="Banner Image" width={400} height={400} className="w-400px transform -translate-y-[3rem] md:-translate-y-0"/>
        </div>
